class Param():
    ...
    def get_hyper_parameters(self, args):
        ...
        elif args.dataset == 'clustered':
            print("==============clustered config")
            hyper_parameters = {
                'pretrained_bert_model': 'google/bert_uncased_L-12_H-768_A-12',
                'max_seq_length': None, 
                'num_pretrain_epochs': 1,
        ...
        elif args.dataset == 'send_new':
            print("==============send_new config")
            hyper_parameters = {
                'pretrained_bert_model': 'google/bert_uncased_L-12_H-768_A-12',
                'max_seq_length': None, 
                'num_pretrain_epochs': 1,
        ...
        elif args.dataset == 'send_new_refined':
            print("==============send_new_refined config")
            hyper_parameters = {
                'pretrained_bert_model': 'google/bert_uncased_L-12_H-768_A-12',
                'max_seq_length': None, 
                'num_pretrain_epochs': 1,
        ...
        elif args.dataset == 'send_new_refined_request':
            print("==============send_new_refined config")
            hyper_parameters = {
                'pretrained_bert_model': 'google/bert_uncased_L-12_H-768_A-12',
                'max_seq_length': None,
        ...
        elif args.dataset == 'send_new_refined_request_provide':
            print("==============send_new_refined config")
            hyper_parameters = {
                'pretrained_bert_model': 'google/bert_uncased_L-12_H-768_A-12',
                'max_seq_length': None, 
